...
function WS_OutBoundOrder($wms_num){
    global $tipobd_totvs, $conexion_totvs;
     ...
     $wsdlUrl = 'http://192.168.100.181/WMSTekWS/wsImportIfz.asmx?WSDL';
    // $wsdlUrl = 'http://192.168.100.183/WMSTekWS/wsImportIfz.asmx?WSDL';
    // $wsdlUrl = 'http://192.168.100.188/WMSTekWS/wsImportIfz.asmx?WSDL';

        $querysel_2 = "SELECT Z.ZC6_WMSNUM,Z.ZC6_TIPWMS, A.A1_TYPECOD, Z.ZC6_OC, Z.ZC6_LOCAL, Z.ZC6_FEMIS, Z.ZC6_ENTREG, Z.ZC6_CLIENT,
            ...
            AND Z.D_E_L_E_T_<>'*'
            GROUP BY Z.ZC6_WMSNUM, Z.ZC6_TIPWMS, A.A1_TYPECOD,Z.ZC6_OC,Z.ZC6_LOCAL,  Z.ZC6_FEMIS,Z.ZC6_ENTREG, Z.ZC6_CLIENT, Z.ZC6_CANAL,
                    A.A1_NOME, A.A1_MUN, A.A1_BAIRRO, A.A1_END, A.A1_BRANCH, A.A1_LOJA, A.A1_NREDUZ, S1.X5_DESCRI,
                    S2.X5_DESCRI, C.R_E_C_N_O_";
        $rs2 = querys($querysel_2, $tipobd_totvs, $conexion_totvs);
        $v2 = ver_result($rs2, $tipobd_totvs);
            $wms_num            = trim($v2["ZC6_WMSNUM"]);
           // $type_cod           = trim($v2["A1_TYPECOD"]);
            $type_cod           = trim($v2["ZC6_TIPWMS"]);
            ...
            try {
                ...
                $query_detail = "SELECT TO_NUMBER(ZC6_ZITEM) AS ZC6_ZITEM, ZC6_ITEM,ZC6_INTCOD,ZC6_CANT ,Z.ZC6_WMSNUM,
                        Z.ZC6_TIPWMS, Z.ZC6_OC, Z.ZC6_FEMIS, Z.ZC6_ENTREG, Z.ZC6_CLIENT,
                ...
                $rsd = querys($query_detail, $tipobd_totvs, $conexion_totvs);
            
                // Recorrer los detalles y agregarlos al array
                while ($v = ver_result($rsd, $tipobd_totvs)) {
                ...
                if($OK == 'OK'){
                    ...
                    $rc5=querys($queryup_c5, $tipobd_totvs, $conexion_totvs);

                    $queryx01 = "INSERT INTO TOTVS.X01010(X01_FILIAL, X01_TICKET, X01_FECHA, X01_ESTTOT, X01_ORIGEN, X01_RETWMS, X01_DTHH, X01_TABLA, X01_RECNO, X01_CONFIR, X01_OBSTIC, X01_REFEST, X01_REFFOL, X01_PROCES, D_E_L_E_T_, R_E_C_N_O_, R_E_C_D_E_L_) 
                                                        VALUES('01', $ticket, '$hoy', 'ENVIADO WMS', 'ECoutBound', '$importOutboundOrderResult', '$ffecha_emision', 'ZC6', 0, ' ', NULL, 'MCH', ' ', ' ', ' ', $recno_x01, 0)";
                    $rsx01 = querys($queryx01, $tipobd_totvs, $conexion_totvs);
